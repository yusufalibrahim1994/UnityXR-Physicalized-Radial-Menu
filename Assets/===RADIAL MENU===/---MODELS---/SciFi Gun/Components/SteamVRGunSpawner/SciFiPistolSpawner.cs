...
namespace Valve.VR.InteractionSystem
{
	...
	public class SciFiPistolSpawner : MonoBehaviour
	{
		//public SteamVR_Action_Boolean releaseGun;
		...
		public bool requireReleaseActionToReturn = true;
		public bool showTriggerHint = true;

		[EnumFlags]
		public Hand.AttachmentFlags attachmentFlags = Hand.AttachmentFlags.ParentToHand | Hand.AttachmentFlags.DetachFromOtherHand | Hand.AttachmentFlags.TurnOffGravity | Hand.AttachmentFlags.SnapOnAttach | Hand.AttachmentFlags.DetachOthers | Hand.AttachmentFlags.TurnOnKinematic | Hand.AttachmentFlags.AllowSidegrade;

		public bool takeBackItem = true; // if a hand enters this trigger and has the item this spawner dispenses at the top of the stack, remove it from the stack
		...
		//public SteamVR_Action_Boolean takeGun;

		[Header("SOUNDS UPON HOVERING ON MENU ITEMS")]
		public AudioClip hoveringSoundClip;
		public float hoveringVolume = 1;
		...
		void Update()
		{
			...
			{
				ItemPackage currentAttachedItemPackage = GetAttachedItemPackage(righthandScript);
			...
			{
				ItemPackage currentAttachedItemPackage = GetAttachedItemPackage(lefthandScript);
		...
		//-------------------------------------------------
		public ItemPackage GetAttachedItemPackage(Hand hand)
		{
